...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: BookReViewGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("BookReViewGenNHibernate", "nhibernateUser", "nhibernatePass");
